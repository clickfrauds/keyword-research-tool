...
export async function onRequestGet(context) {
  ...
  const [seo_json_url, master_csv_url, ads_csv_url, negatives_csv_url, guard_js_url, audiences_csv_url, audiences_negatives_csv_url, rsa_csv_url, locations_csv_url] = await Promise.all([
    probe("seo.json"), probe("master.csv"), probe("editor.csv"), probe("negatives.csv"), probe("guard.js"), probe("audiences.csv"), probe("audiences_negatives.csv"), probe("rsa.csv"), probe("locations.csv"),
  ]);

  return new Response(
    JSON.stringify({ status: "ready", html: htmlContent, seo_json_url, master_csv_url, ads_csv_url, negatives_csv_url, guard_js_url, audiences_csv_url, audiences_negatives_csv_url, rsa_csv_url, locations_csv_url }),
