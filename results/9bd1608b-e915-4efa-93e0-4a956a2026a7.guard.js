...
function main() {
  ...
  var FORBIDDEN_LOCATIONS = [
    ...
    "kuwait", "muscat", "oman", "qatar", "ras al khaimah", "riyadh",
    "saudi arabia", "sharjah", "umm al quwain", "أبوظبي", "الشارقة", "عجمان"
  ];
  ...
  var EDU_CAREER = [
    ...
    "define", "definition", "diagram", "difference between mcb and mccb",
    "diploma", "dukan kaise", "electrical engineering degree", "electrical safety certificate course",
    "electrician apprenticeship dubai", "electrician certification uae", "electrician course dubai", "electrician exam questions",
    "electrician job vacancy dubai", "electrician ki salary", "electrician license renewal dubai", "electrician license uae",
    "electrician salary dubai", "electrician tool kit list", "electrician training institute uae", "ev charger types explained",
    "hiring", "how do", "how does", "how to become",
    "how to become an electrician", "in hindi", "in urdu", "institute",
    "internship", "interview questions", "items list", "iti electrician course",
    "job", "jobs", "ka kaam", "ka kam",
    "kaise bane", "kaise bane electrician", "kaise khole", "kaise seekhe",
    ...
    "translate", "types of", "types of circuit breakers", "types of db boards",
    "types of wiring cable sizes", "vacancies", "vacancy", "voltage standard uae",
    "wage", "wages", "what happens", "what is",
    "what is amperage rating", "wire gauge size chart", "دورة كهربائي", "راتب كهربائي في دبي",
    "شهادة كهربائي"
  ];

  var INFO_DIY = [
    "circuit breaker error meaning", "difference between", "diy", "diy electrical repair",
    "do it yourself", "electrical fault finding guide", "electrical panel labeling guide", "electrical wiring diagram",
    "ghar par kaise", "how to", "how to change a switch yourself", "how to check for short circuit",
    "how to fix electrical short circuit", "how to install a socket yourself", "how to install ev charger at home diy", "how to reset circuit breaker",
    "how to reset db board", "how to test electrical socket", "how to wire a switch diy", "instructions",
    "khud banana", "khud lagana", "khud se", "ki setting",
    "manual", "tutorial", "what causes", "why does my breaker keep tripping",
    "wikipedia", "youtube"
  ];

  var FORBIDDEN_WORDS = [
    "ac repair", "b2b electrical supply", "buy electrical wire", "cable manufacturer", "carpenter", "cctv installation",
    "cleaning services", "electrical company jobs", "electrical distributor", "electrical equipment for sale", "electrical equipment supplier", "electrical equipment wholesale dubai",
    "electrical goods store", "electrical items online", "electrical parts shop", "electrical shop near me", "electrician career", "electrician certificate",
    "electrician course", "electrician cv", "electrician job vacancy", "electrician jobs dubai", "electrician recruitment agency", "electrician resume",
    "electrician salary", "electrician training", "electrician visa", "false ceiling", "furniture", "generator repair",
    "gypsum work", "handyman jobs", "hvac", "interior design", "internet cabling", "ka dam",
    "ka price", "khareedna", "kharidna", "ki qeemat", "kitna hai", "kitne ka",
    "labour supply", "landscaping", "manpower supply", "moving company", "networking cabling", "painter",
    "pest control", "plumber", "renovation contractor", "rent electrical tools", "sasta", "solar panel installation",
    "swimming pool maintenance", "used electrical equipment", "vacancy electrician", "wholesale electrical supplies", "wire manufacturer dubai", "خدمة سباكة",
    "راتب كهربائي", "وظيفة كهربائي"
  ];
  ...
  var SAFE_ROOTS = [
    ...
    "24 hour electrician dubai price", "24 hr electrical services near me", "24hr electrician near me", "24hrs electrician near me",
    "24x7 electrician near me", "amc electrical services dubai", "annual electrical maintenance contract dubai", "best electrician dubai price",
    "best emergency electricians near me", "building electrical maintenance dubai", "db board repair dubai", "electrical contractors in dubai",
    "electrical emergency service near me", "electrical maintenance company in dubai", "electrical maintenance company near me dubai", "electrical maintenance contract dubai",
    "electrical maintenance dubai", "electrical repair dubai", "electrical safety inspection dubai", "electrical technician dubai",
    "electrical work in dubai", "electrical work services in dubai", "electrician call out dubai", "electrician dubai",
    "electrician dubai marina", "electrician emergency near me", "electrician marina dubai", "electrician near me now",
    "electrician near me open now dubai", "electrician quote dubai", "electrician required in dubai", "electrician service dubai",
    "emergency electrical service near me", "emergency electrician cost dubai", "emergency electrician dubai", "emergency electrician dubai marina call now",
    "emergency electrician hotline dubai", "emergency electrician near me", "emergency electrician near me now", "emergency electrician service near me",
    "emergency electricians in my area", "ev charger installation dubai", "fast electrician response dubai", "fast response electrician dubai",
    "hire electrician dubai", "house wiring dubai", "house wiring electrician dubai", "office electrician dubai",
    "power outage electrician dubai", "preventive electrical maintenance dubai", "same day electrician near me", "short circuit emergency repair dubai",
    "short circuit repair dubai", "socket installation dubai", "switch installation dubai", "switch installation dubai price",
    "urgent electrician call out dubai", "villa electrician dubai", "weekend electrician dubai", "weekend emergency electrician dubai",
    "wiring installation cost dubai", "كهربائي دبي", "كهربائي طوارئ دبي"
  ];

  var PRODUCTS = [
    "abb", "clipsal", "electrical", "electrician", "hager", "legrand",
    "mk electric", "price", "schneider", "siemens"
  ];
  ...
  var PROBLEMS = [
    ...
    "burning smell electrical", "burnt socket", "burst", "buzzing sound from panel",
    "circuit overload", "clogged", "corroded", "crack",
    "cracked", "damage", "damaged", "db board tripping",
    "dripping", "electric shock from socket", "electric shock risk", "electrical fire hazard",
    "electricity cut off", "ev charger not working", "exposed wires", "fault",
    "faulty", "fuse blown", "half power in house", "issue",
    "issues", "jammed", "kharab", "leakage",
    "leaking", "leaky", "lights flickering", "low pressure",
    "no electricity in office", "no power in house", "noise", "noisy",
    "not turning on", "not working", "overflow", "overflowing",
    "overheating", "power fluctuation", "power outage", "power tripping repeatedly",
    "problem", "problems", "rusted", "short circuit",
    "slow", "smell", "smells", "smelly",
    "smoke from db board", "socket not working", "sparking socket", "stopped working",
    "stuck", "sudden power loss", "switch not working", "tripped mcb",
    "tripping", "tripping breaker", "vibrating", "weak",
    "wiring fault", "won't work", "wont turn", "wont work"
  ];

  // Head service tokens — 1-edit misspellings of these are KEPT as leads
  var FUZZY_ROOTS = [
    "annual", "electrical", "electrician", "electricians", "marina", "wiring"
  ];
