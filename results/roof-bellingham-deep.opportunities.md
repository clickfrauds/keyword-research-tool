...
- Filters: `Call` · payout ≥ **$25** · population **8,000–150,000** · niches **Roofing**
- **1** candidate cities · **3** SERP-scored · SerpApi: 2 credit(s) spent · 1 served free from cache
- Verdict by city: **0 GO** · 0 WATCH · 1 STOP
...
<details><summary>1 STOP cities</summary>

| City | Why |
|---|---|
| Bellingham, WA | `roof leak repair Bellingham WA`: 4 dedicated roofing pages |
...
|---|---|---|---|---|---|---|---|
| 1 | **23** | 35 | $66.15 | 110 | 3× 75 rev | `roofer Bellingham WA` | 2 dedicated, 0 EMD, 0 pSEO, 3 local, 3 directory |
| 2 | **23** | 35 | $66.15 | 110 | none | `roof leak repair Bellingham WA` | 4 dedicated, 0 EMD, 0 pSEO, 2 local, 2 directory |
| 3 | **23** | 35 | $66.15 | 110 | 3× 75 rev | `roof repair Bellingham WA` | 4 dedicated, 0 EMD, 0 pSEO, 2 local, 2 directory |
